 ...
 * @module index
 */
import { signBytes, blake2b, base58Encode, publicKey, concat } from '@acryl/ts-lib-crypto'
import { schemas, serializePrimitives } from '@acryl/marshall'
import { IDataEntry } from '../transactions'
import { serializerFromSchema } from '@acryl/marshall/dist/serialize'
