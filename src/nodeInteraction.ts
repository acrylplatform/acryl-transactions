...
import { json } from '@acryl/marshall'
...
const DEFAULT_NODE_REQUEST_OPTIONS = {
  timeout: 120000,
  apiBase: "https://nodes.acrylplatform.com"
}
 ...
 * @param txId - acryl address as base58 string
 * @param options
 */
 ...
 * @param address - acryl address as base58 string
 * @param nodeUrl - node address to ask balance from. E.g. https://nodes.acrylplatform.com/
 */
 ...
 * @param address - acryl address as base58 string
 * @param nodeUrl - node address to ask data from. E.g. https://nodes.acrylplatform.com/
 */
 ...
 * @param nodeUrl - node address to send tx to. E.g. https://nodes.acrylplatform.com/
 */
