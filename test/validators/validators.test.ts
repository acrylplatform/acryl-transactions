...
describe('Validators', () => {
    ...
    describe('Atomic validators', () => {
        ...
        it('Valid Acryl Address', () => {
            expect(validators.isValidAddress(null)).toBe(false)
            expect(validators.isValidAddress(Object.create(null))).toBe(false)
            expect(validators.isValidAddress('3EHt9NerduyUBYP4qnf3FtnuNUeNfw22Lo9')).toBe(true)
            expect(validators.isValidAddress('3EHt9NerduyUBYP4qnf3FtnuNUeNfw22Lo9', 'K'.charCodeAt(0))).toBe(false)
            expect(validators.isValidAddress('3EHt9NerduyUBYP4qnf3FtnuNUeNfw22Lo9', 'A'.charCodeAt(0))).toBe(true)
            expect(validators.isValidAddress('3EHt9NerduyUBYP4qnf3FtnuNUeNfw22L', 'A'.charCodeAt(0))).toBe(false)
            expect(validators.isValidAddress('3EHt9NerduyUBYP4qnf3FtnuNUeNfw22Lo0')).toBe(false)
        })
        
        it('Valid Acryl Alias', () => {
            expect(validators.isValidAlias('alias:A:test')).toBe(true)
            expect(validators.isValidAlias('alias:K:test1')).toBe(true)
            expect(validators.isValidAlias('alias:K:helloisalongaliasfortestwith30')).toBe(true)
            expect(validators.isValidAlias('test1')).toBe(false)
            expect(validators.isValidAlias('alias:A:tes')).toBe(false)
            expect(validators.isValidAlias('alias:A:helloisalongaliasfortestmorethan30simbols')).toBe(false)
            expect(validators.isValidAlias('alias:A:truealias:wrongalias')).toBe(false)
            expect(validators.isValidAlias('alias:A:WrongAlias')).toBe(false)
    
        })
        
        it('Is recipient', () => {
            expect(validators.isRecipient('alias:A:test')).toBe(true)
